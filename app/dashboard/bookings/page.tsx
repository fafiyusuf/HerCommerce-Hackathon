...
export default function BookingsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-12">
      <h1 className="text-4xl font-heading font-bold text-foreground mb-8">My Bookings</h1>
      <p className="text-lg text-muted-foreground mb-8">Manage your vendor bookings and requests</p>
      {bookings.length > 0 ? (
